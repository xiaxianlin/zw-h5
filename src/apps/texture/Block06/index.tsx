...
export function Block06() {
  ...
  return (
    <div ref={ref} className="block">
      <div className="bg">
        <animated.img src="/resources/block06/bg.png" />
      </div>
      <div className="content info-content">
        <animated.img className={styles.title} style={title.styles} src="/resources/block06/title.png" />
        <animated.img className={styles.example} style={example.styles} src="/resources/block06/example.png" />
        <animated.img className={styles.demo} style={demo.styles} src="/resources/block06/demo.png" />
        <animated.img className={styles.intro} style={intro.styles} src="/resources/block06/intro.png" />
      </div>
    </div>
  );
}
